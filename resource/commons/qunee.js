...
window.Q = function (t, i, n) {
    ...
    var bY = S({
        ...
        _34: function (t) {
            ...
            if (n) if (this[bu]) {
                var e, s;
                if (B(n)) for (var h = 0, r = n.length; r > h; h++) s = n[h].id, e = this._mz[Yd](s), e && (e[qT] = i.containsById(s), e[YT]()); else {
                ...
                this._$f || (this._$f = {});
                var e, s;
                if (B(n)) for (var h = 0, r = n.length; r > h; h++) s = n[h].id, this._$f[s] = !0; else s = n.id, this._$f[s] = !0
            }
        },
        _l1: null,
        _dq: function (t) {
